package com.test.health.im.common.utils;

import com.test.health.im.common.exception.LengthOverflowException;
...
public class ByteBufferUtils {
	...
	public static ByteBuffer composite(ByteBuffer byteBuffer1, byte[] buff, int len) {
