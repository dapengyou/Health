...
/**
 * Created by lady_zhou on 2018/4/27.
 */

public class AddressAdapter extends BaseAdapter implements SectionIndexer {

    private List<ContactSortBean> list = null;
    private Context mContext;

    public AddressAdapter(Context mContext, List<ContactSortBean> list) {
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        final ContactSortBean mContent = list.get(position);
        if (view == null) {
